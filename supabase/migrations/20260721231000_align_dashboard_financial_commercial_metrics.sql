-- Alinha a Dashboard:
-- - indicadores financeiros usam a data real da transação;
-- - indicadores comerciais de entrega usam a data de entrega;
-- - ticket médio usa o valor comercial dos pedidos entregues, não o caixa recebido.
