-- Separa caixa oficial e histórico comercial pela data real da transação.
-- Regra:
-- - transações antes de 01/08/2026 não entram no financeiro oficial;
-- - pagamentos antes do marco de pedidos entregues depois do marco entram no histórico comercial;
-- - pedidos entregues até 31/07/2026 permanecem no histórico comercial sem duplicar suas transações.
